...
#import "ContractDetailSignView.h"
#import "Defines.h"

@interface ContractDetailSignView () <UITableViewDelegate>
...
@implementation ContractDetailSignView
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIViewController *vc = [[AWMediator sharedInstance] openVCWithName:@"SignFormVC" params:self.dataSource.dataSource[indexPath.row]];
...
{
    if ( !_dataSource ) {
        _dataSource = AWTableViewDataSourceCreate(nil, @"ContractSignCell", @"cell.id");
    }
    return _dataSource;
}
