...
#import "LandPayListVC.h"
#import "Defines.h"

@interface LandPayListVC () <UITableViewDelegate>
...
@implementation LandPayListVC

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.navBar.title = @"付款方式";
...
{
    if ( !_dataSource ) {
        _dataSource = AWTableViewDataSourceCreate(nil, @"LandPayCell", @"cell.id");
    }
    return _dataSource;
}
